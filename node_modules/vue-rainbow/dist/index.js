...
var exposeAction = function exposeAction(DOM, cb) {
  var triggerOnce = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  ...
  var mixin = {
    ...
    methods: {
      ...
      getRecommendDeal: function getRecommendDeal(cityId, categoryIdsStr, pageSize, pageNum, longitude, latitude, platform, dpid, token) {
        ...
        var requestUrl = this.determinePlatform(platform) == MEITUAN ? "//promo.dianping.com/mtlist/rec/getDealList.jsonp" : "//promo.dianping.com/list/rec/getDealList.jsonp";
